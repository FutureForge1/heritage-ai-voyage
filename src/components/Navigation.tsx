...
import { Home, Search, Palette, User } from "lucide-react";
...
const Navigation = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 h-16 bg-heritage-paper border-t border-heritage-gold/30 flex items-center justify-around z-10">
